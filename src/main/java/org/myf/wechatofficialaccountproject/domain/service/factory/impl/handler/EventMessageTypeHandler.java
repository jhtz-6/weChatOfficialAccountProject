...
public class EventMessageTypeHandler implements MessageTypeHandler {
    ...
    static final MessageContentHandlerChain eventMessageContentHandlerChain =
        (MessageContentHandlerChain)ApplicationContextUtil.getBeanByName("eventMessageContentHandlerChain");
